...
Media.prototype.getDurationAudio = function(success, fail) { 
    var me = this;   exec(function(p) {     me._duration = p;     success(p);   }, fail, "Media", "getDurationAudio", [this.id, this.src]); 
};
...
Media.prototype.getAudioFullPath=function (success,fail) {
    exec(function(path){
